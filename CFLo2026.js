...
function LoadResults() {
    ...
    allResults.push(new Result(2026, 2, TEAMS.Hamilton, 37, TEAMS.Winnipeg, 27));
    allResults.push(new Result(2026, 2, TEAMS.Toronto, 30, TEAMS.Montreal, 37));
    allResults.push(new Result(2026, 2, TEAMS.BC, 27, TEAMS.Saskatchewan, 31));

    allResults.push(new Result(2026, 3, TEAMS.BC, 27, TEAMS.Hamilton, 41));
    allResults.push(new Result(2026, 3, TEAMS.Toronto, 44, TEAMS.Ottawa, 24));
    allResults.push(new Result(2026, 3, TEAMS.Montreal, 29, TEAMS.Edmonton, 32));
    allResults.push(new Result(2026, 3, TEAMS.Saskatchewan, 40, TEAMS.Calgary, 37));

    allResults.push(new Result(2026, 4, TEAMS.Edmonton, 23, TEAMS.Winnipeg, 18));
    allResults.push(new Result(2026, 4, TEAMS.Toronto, 40, TEAMS.Saskatchewan, 34));
    ...
    allResults.push(new Result(2026, 6, TEAMS.Ottawa, 17, TEAMS.Edmonton, 40));
    allResults.push(new Result(2026, 6, TEAMS.Toronto, 21, TEAMS.Winnipeg, 30));
    allResults.push(new Result(2026, 6, TEAMS.Calgary, 30, TEAMS.Montreal, 37));
    allResults.push(new Result(2026, 6, TEAMS.Hamilton, 7, TEAMS.Saskatchewan, 38));

    allResults.push(new Result(2026, 7, TEAMS.BC, 17, TEAMS.Edmonton, 19));
    allResults.push(new Result(2026, 7, TEAMS.Montreal, 38, TEAMS.Calgary, 32));
    allResults.push(new Result(2026, 7, TEAMS.Toronto, 23, TEAMS.Hamilton, 24));
    allResults.push(new Result(2026, 7, TEAMS.Winnipeg, 36, TEAMS.Ottawa, 34));

    allResults.push(new Result(2026, 8, TEAMS.Edmonton, 36, TEAMS.Saskatchewan, 34));
    allResults.push(new Result(2026, 8, TEAMS.Calgary, 52, TEAMS.Winnipeg, 30));
    allResults.push(new Result(2026, 8, TEAMS.Toronto, 26, TEAMS.BC, 12));
    allResults.push(new Result(2026, 8, TEAMS.Hamilton, 18, TEAMS.Montreal, 31));

    allResults.push(new Result(2026, 9, TEAMS.BC, 35, TEAMS.Winnipeg, 19));
    allResults.push(new Result(2026, 9, TEAMS.Montreal, 34, TEAMS.Ottawa, 13));
    allResults.push(new Result(2026, 9, TEAMS.Calgary, 44, TEAMS.Hamilton, 20));
    allResults.push(new Result(2026, 9, TEAMS.Saskatchewan, 28, TEAMS.Edmonton, 26));

    allResults.push(new Result(2026, 10, TEAMS.Calgary, 30, TEAMS.Toronto, 33));
    allResults.push(new Result(2026, 10, TEAMS.Ottawa, 20, TEAMS.Saskatchewan, 42));
    allResults.push(new Result(2026, 10, TEAMS.Edmonton, 30, TEAMS.Montreal, 48));
    allResults.push(new Result(2026, 10, TEAMS.Hamilton, 24, TEAMS.BC, 27));

    allResults.push(new Result(2026, 11, TEAMS.BC, 30, TEAMS.Calgary, 26));
    allResults.push(new Result(2026, 11, TEAMS.Ottawa, 21, TEAMS.Winnipeg, 33));
    allResults.push(new Result(2026, 11, TEAMS.Toronto, 12, TEAMS.Edmonton, 42));
    allResults.push(new Result(2026, 11, TEAMS.Saskatchewan, 19, TEAMS.Hamilton, 26));

    allResults.push(new Result(2026, 12, TEAMS.Ottawa, 16, TEAMS.Montreal, 46));
    allResults.push(new Result(2026, 12, TEAMS.Winnipeg, 19, TEAMS.Edmonton, 22));
    allResults.push(new Result(2026, 12, TEAMS.Hamilton, 20, TEAMS.Toronto, 39));
    allResults.push(new Result(2026, 12, TEAMS.Saskatchewan, 16, TEAMS.BC, 30));

    allResults.push(new Result(2026, 13, TEAMS.Montreal, 28, TEAMS.Winnipeg, 44));
    ...
    allResults.push(new Result(2026, 15, TEAMS.Ottawa, 23, TEAMS.Toronto, 26));
